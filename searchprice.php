<?php
    ...
    {
      $apartment = mysqli_query($con, "SELECT * FROM apartment WHERE apartment.price BETWEEN '{$_POST['sfrom']}' AND '{$_POST['sto']}' AND apartment.apartment_for LIKE '%Rent%' ORDER BY apartment.price ASC");
      mysqli_close($con);
    }
		?>
