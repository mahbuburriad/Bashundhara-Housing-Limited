<?php
    ...
    {
      $apartment = mysqli_query($con, "SELECT * FROM apartment WHERE apartment.price BETWEEN '{$_POST['sfrom']}' AND '{$_POST['sto']}' AND block_no = '{$_POST['block_no']}' OR bed = '{$_POST['bed']}' OR washroom = '{$_POST['washroom']}' AND apartment.apartment_for LIKE '%Rent%' ");
      mysqli_close($con);
    }
		?>
