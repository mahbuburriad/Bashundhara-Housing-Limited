    ...
    {
      $apartment = mysqli_query($con, "SELECT * FROM apartment WHERE apartment.apartment_for LIKE '%Rent%' ORDER BY date_a DESC");
      mysqli_close($con);
    }
		?>
...
<form name="price" method="post" style="float: left;" action="searchprice.php">
<strong>Price</strong>
  ...
  <form name="price" method="post" style="float: left;" action="searchwhole.php">
...
<input type="submit" name="submit" value="Go" style="width:40px; padding:3px; border-radius: 40px;" />
    ...
    <p>
<form name="searchblock" method="post" style="float: right;" action="searchblock.php">
