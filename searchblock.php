<?php
    ...
    if(!mysqli_connect_errno())
    {
      ...
      $apartment = mysqli_query($con, "SELECT * FROM apartment WHERE apartment.block_no LIKE '{$_POST['block_no']}' AND apartment.apartment_for LIKE '%Rent%' ORDER BY date_a ASC");
      mysqli_close($con);
    }
		?>
