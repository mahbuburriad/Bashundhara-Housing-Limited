<?php
    ...
    {
      $email = mysqli_query($con, "SELECT * FROM email WHERE email.date_e = '{$_POST['date_e']}' AND email.month_e = '{$_POST['month_e']}' AND email.year_e =  '{$_POST['year_e']}'AND reciever LIKE '%manager%' ORDER BY date_e DESC ");
