<?php
    ...
    {
      $land_owner_list = mysqli_query($con, "SELECT * FROM land_owner_list WHERE land_owner_list.first_name LIKE '%{$_POST['first_name']}%' OR land_owner_list.last_name LIKE '%{$_POST['first_name']}%'");
      mysqli_close($con);
    }
		?>
