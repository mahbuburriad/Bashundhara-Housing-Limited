<?php
    ...
    {
      $land_owner_list = mysqli_query($con, "SELECT * FROM land_owner_list WHERE land_owner_list.Flat_L = '{$_POST['Flat_L']}' AND land_owner_list.House_L = '{$_POST['House_L']}' AND land_owner_list.Road_L = '{$_POST['Road_L']}' AND land_owner_list.block = '{$_POST['block']}'");
      mysqli_close($con);
    }
		?>
