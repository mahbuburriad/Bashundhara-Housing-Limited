    ...
    {
      $plot = mysqli_query($con, "SELECT * FROM plot WHERE plot.plot_for1 LIKE '%sell%' ORDER BY date_a1 DESC");
      mysqli_close($con);
    }
		?>
...
<form name="price" method="post" style="float: left" action="searchpricebs.php">
<strong>Price</strong>
  ...
  <form name="whole" method="post" style="float: right;" action="searchwholeps.php">
...
<input type="submit" name="submit" value="Go" style="width:40px; padding:3px; border-radius: 40px;" />
    ...
    <p>
<form name="searchblock" method="post" style="float: left;" action="searchblockbs.php">
