<?php
    ...
    {
      //$stuff_list = mysqli_query($con, "SELECT * FROM stuff_list WHERE stuff_list.salary BETWEEN '{$_POST['sfrom']}' AND '{$_POST['sto']}' ORDER BY stuff_list.salary ASC");
      $stuff_list = mysqli_query($con, "SELECT * FROM stuff_list WHERE stuff_list.stuffas LIKE '{$_POST['stuffas']}' ORDER BY id ASC");
      mysqli_close($con);
    }
		?>
