...
<form name="date" method="post" style="float: left;" action="searchdatena.php">
<strong>Date</strong>
  ...
  <form name="date" method="post" style="float: left;" action="dutyadmina.php">
  <strong>Block</strong>
...
<table style="background-color: white;">
  ...
  foreach($duty as $dutys)
    ...
    <a style="vertical-align: middle;" href="editduty.php?did=<?php echo $dutys['did']; ?>"><img src="resources\image\edit.ico" alt="Edit" style="height: 20px; width: 20px;" /></a> &nbsp;&nbsp;
    <a style="vertical-align: middle;" href="deleteduty.php?did=<?php echo $dutys['did']; ?>"><img src="resources\image\delete.png" alt="Delete" style="height: 20px; width: 20px;" /></a> &nbsp;&nbsp;
    </td>
      </tr>
      <?php
      $sl_no++;
