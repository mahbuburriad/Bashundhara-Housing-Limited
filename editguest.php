    ...
    {
      $guest_list = mysqli_query($con, "SELECT * FROM guest_list WHERE guest_list.id= {$_GET['id']}");
      mysqli_close($con);
    }
...
<p>
<form name="guest_list" method="post" action="saveguestedit.php?id=<?php echo "{$_GET['id']}" ?>">
<p>
	...
	<strong>Password</strong>
	 <input type="text" name="password" value="<?php echo $guest_lists['password'];?>" placeholder="Enter your Password"/><br />
	 </p>
	<p>
