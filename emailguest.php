    ...
    {
      $email = mysqli_query($con, "SELECT * FROM email WHERE reciever LIKE '%guest%' ORDER BY date_e DESC");
      mysqli_close($con);
    }
		?>
...
<form name="email" method="post" action="searchdatee.php">
<strong>Date</strong>
  ...
  <form name="emailsu" method="post" action="searches.php">
