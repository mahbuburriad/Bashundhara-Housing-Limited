		...
		VALUES('".$_POST['first_name']."','".$_POST['last_name']."','".$_POST['user_id']."','".$_POST['email']."','".$_POST['password']."','".$_POST['gender']."','".$_POST['month']."','".$_POST['date']."','".$_POST['year']."','".$_POST['mobileno']."', '".$_POST['salary']."','".$_POST['stuffas']."','".$_POST['Flat']."','".$_POST['House']."','".$_POST['Road']."','".$_POST['Thana']."','".$_POST['District']."','".$_POST['Country']."');";
