<?php
    ...
    {
      $plot = mysqli_query($con, "SELECT * FROM plot WHERE plot.block_no1 LIKE '{$_POST['block_no1']}' AND plot.price BETWEEN '{$_POST['sfrom']}' AND '{$_POST['sto']}' AND plot.plot_for1 LIKE '%Rent%'");
      mysqli_close($con);
    }
		?>
